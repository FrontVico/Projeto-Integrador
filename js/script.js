document.addEventListener('DOMContentLoaded', () => {
  ...
  function getElementColorClass(element) {
    ...
    if (element.category === 'alkali') return 'bg-red-100 hover:bg-red-200';
    if (element.category === 'alkaline') return 'bg-orange-100 hover:bg-orange-200';
    if (element.category === 'transition') return 'bg-blue-100 hover:bg-blue-200';
    if (element.category === 'halogen') return 'bg-green-100 hover:bg-green-200';
    if (element.category === 'noble') return 'bg-cyan-100 hover:bg-cyan-200';
    if (element.category === 'metalloid') return 'bg-purple-100 hover:bg-purple-200';
    if (element.category === 'nonmetal') return 'bg-green-100 hover:bg-green-200';
    if (group >= 3 && group <= 12) return 'bg-blue-100 hover:bg-blue-200';
